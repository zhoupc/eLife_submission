...
%% play and save
ax_y =   axes('position', [0.015, 0.515, 0.3, 0.45]);
ax_bg=   axes('position', [0.015, 0.001, 0.3, 0.45]);
ax_signal=    axes('position', [0.345, 0.515, 0.3, 0.45]);
ax_denoised =    axes('position', [0.345, 0.001, 0.3, 0.45]);
ax_res =    axes('position', [0.675, 0.515, 0.3, 0.45]);
ax_mix =     axes('position', [0.675, 0.001, 0.3, 0.45]);
