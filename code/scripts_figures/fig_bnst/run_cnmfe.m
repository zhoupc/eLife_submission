...
ring_radius = 23;  % when the ring model used, it is the radius of the ring used in the background model.
%otherwise, it's just the width of the overlapping area
num_neighbors = []; % number of neighbors for each neuron
thresh_outlier = 10; 
bg_ssub = 2;     % downsampling data during background estimation 
...
dmin = 20;       % minimum distances between two neurons. it is used together with merge_thr
...
neuron.update_temporal_parallel(use_parallel, false);
if update_sn
...
range_ac = 5+[0, amp_ac];
multi_factor = 3;
range_Y = 250+[0, amp_ac*multi_factor];
