...
[center, Cn, PNR] = neuron.initComponents_parallel(1, [], save_initialization, use_parallel, use_prev);
neuron.A = A; 
neuron.C = C; 
neuron.ids = (1:size(A, 2)); 
...
RSS_true = [RSS_init, RSS_residual, RSS_iter0, RSS_iter_1, RSS_iter_2, RSS_iter_3, ...
