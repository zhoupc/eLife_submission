...
num_neighbors = 30; % number of neighbors for each neuron  
...
merge_thr_spatial = [0.8, 0.2, 0];  % merge components with highly correlated spatial shapes (corr=0.8) and small temporal correlations (corr=0.1)
